		...
		<div class="container customer_cont">
			<div class="online-reg__inner">
				...
				<div class="online-reg__contents">
					<form action="./online_reg_write_action.php" method="post" class="register_form" name="frm" target="_fra_admin" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="register_table">
								<ul class="row">
									<li class="tit">제목</li>
									<li class="desc">
										<input type="text" name="subject" placeholder="제목을 입력해 주세요." class="w100p">
								...
								<ul class="row flex-row">
									<ul class="row-item">
										<li class="tit">작성자</li>
										<li class="desc">
											<input type="text" name="writer" placeholder="작성자명을 입력해 주세요." class="w100p">
											<!-- <span class="err-txt">작성자명을 입력해 주세요.</span> -->
										</li>
									</ul>
									<ul class="row-item">
										<li class="tit">비밀번호</li>
										<li class="desc">
											<input type="password" name="password" placeholder="비밀번호를 입력해 주세요." class="w100p">
											<!-- <span class="err-txt">비밀번호를 입력해 주세요.</span> -->
										</li>
									</ul>
								</ul>
								<ul class="row">
									...
									<li class="desc">
										<textarea name="content" placeholder="문의 내용을 입력해 주세요. &#13;&#10;연락을 원하시면 연락처를 남겨주세요." class="w100p"></textarea>
					...
					<div class="btn-area right mt44">
						<a href="./online.php" class="btn btn-md gray">취소</a>
						<button type="button" onclick="frm.submit()" class="btn btn-md pink">등록</button>
					</div>
				</div>
			</div>
		</div>

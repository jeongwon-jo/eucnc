...
<!--								<img src="/_img/reference/reward-dtl1.png" alt=""><br>-->
<!--								<img src="/_img/reference/reward-dtl2.png" alt=""><br>-->
<!--								<img src="/_img/reference/reward-dtl3.png" alt=""><br>-->
<!--								<img src="/_img/reference/reward-dtl4.png" alt=""><br>-->
<!--								<p>관련기사 : https://newsis.com/view/?id=NISX20230427_0002282670&cID=10433&pID=13000</p>-->
							</div>
						</div>
					</div>
					<div class="btn-area center mt32">
						...
						if($prev_result->num_rows > 0){
							...
							?>
							<a href="./reward_dtl.php?idx=<?=$prev_row['idx']?>&<?=$total_param?>" class="btn btn-md gray">이전</a>
						<? } ?>
						<a href="./reward.php?<?=$total_param?>" class="btn btn-md white">목록</a>
						<?
						if($next_result->num_rows > 0){
							$next_row = $next_result->fetch_array();
							?>
							<a href="./reward_dtl.php?idx=<?=$next_row['idx']?>&<?=$total_param?>" class="btn btn-md pink">다음</a>
						<? } ?>
					</div>
				</div>
			</div>

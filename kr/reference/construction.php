	...
	<main>
			...
			<div class="menu-title__inner">
				...
				<div class="sub-menu">
					<ul class="submenu_list">
						...
						<li class="active"><a href="./construction.php">시공사례</a></li>
		...
		<div class="container reference">
			<div class="construct__inner">
				<div class="cm_title">
					<h3 class="title">시공사례</h3>
				</div>
				<div class="construct__contents">
					<div class="card_list"></div>
					<div class="btn-area center mt90">
						<button type="button" class="btn_more" onclick="ajax_patent('kor', currentPage+1, 12)"><b>더보기 (<span

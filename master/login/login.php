...
<div id="wrap" class="skin_type01">
	...
	<div class="login_box">
		<div class="logo">
			<h1><?=$_SITE_TITLE?> 관리자</h1>
			<h2>ADMINISTRATOR</h2>
		</div>
		<div class="login">
			<p class="txt">관리자 페이지 입니다. <br>아이디와 패스워드를 입력해주세요 <?//=md5("admin")?></p>
			...
			<input type="hidden" name="reurl_go" value="<?=$reurl_go?>">
				<fieldset>
					...
					<div class="input_pw mt10">
						<span><input type="password" title="password" placeholder="비밀번호" name="lms_pass" id="lms_pass" tabindex = "2" maxlength="6"  required="yes" message="비밀번호" onKeypress="if(event.keyCode ==13){go_submit();return;}"></span>
					</div>

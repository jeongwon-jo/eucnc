		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<form action="./download_write_action.php" method="post" enctype="multipart/form-data" name="frm" target="_fra_admin" id="frm">
						...
						<div class="write">
							<table>
								...
								<tr>
									...
									<td colspan="3">
										<textarea name="kor_content" id="editor1"></textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea name="eng_content" id="editor2"></textarea>
									</td>
								</tr>

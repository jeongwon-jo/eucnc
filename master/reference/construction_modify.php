...
$query = " SELECT * FROM construction_info WHERE `idx` = '$idx' ";
		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<form action="./construction_modify_action.php" method="post" enctype="multipart/form-data" name="frm" target="_fra_admin" id="frm">

		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<form action="./festival_write_action.php" method="post" enctype="multipart/form-data" name="frm" target="_fra_admin" id="frm">
						...
						<div class="write">
							<table>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" style="width:100%;" name="kor_subject">
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" style="width:100%;" name="eng_subject">
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" style="width:100%;" name="kor_content">
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" style="width:100%;" name="eng_content">
									</td>
								</tr>

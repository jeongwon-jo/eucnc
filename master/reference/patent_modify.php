...
$query = " SELECT * FROM patent_info WHERE `idx` = '$idx' ";
		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<form action="./patent_modify_action.php" method="post" enctype="multipart/form-data" name="frm" target="_fra_admin" id="frm">
						...
						<div class="write">
							<table>
								...
								<tr>
									<th scope="row">번호</th>
									<td colspan="3">
										<input type="text" style="width:100%;" name="number" value="<?=$row['number']?>" required="yes" message="번호">
									</td>
								</tr>

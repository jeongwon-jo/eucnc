...
$query = " UPDATE certification_info SET ";
...
if($result){
	error_frame_go("인증서 데이터 수정 작업을 정상적으로 완료했습니다.", "./certification_list.php?$total_param");
}else{
	error_frame("인증서 데이터 수정 작업 도중에 알 수 없는 오류가 발생했습니다.");
}
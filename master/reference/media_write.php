		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<form action="./media_write_action.php" method="post" enctype="multipart/form-data" name="frm" target="_fra_admin" id="frm">
						...
						<div class="write">
							<table>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" name="wdate" style="width:25%; vertical-align:middle;"
											   ...
											   message="등록일" value="<?=date("Y-m-d")?>" readonly>
									</td>
								</tr>
								...
								<tr>
									<th scope="row">링크</th>
									<td colspan="3">
										<input type="text" style="width:100%;" name="link" required="yes" message="링크">
									</td>
								</tr>

		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<form action="./inquiry_modify_action.php" method="post" enctype="multipart/form-data" name="frm" target="_fra_admin" id="frm">
						...
						<div class="write">
							<table>
								...
								<tr>
									<th scope="row">답변</th>
									<td colspan="3">
										<textarea style="width:100%;height:100%;" name="answer" id="editor2"><?=$row['answer']?></textarea>
									</td>
								</tr>
								...
								<tr>
									<th scope="row">파일</th>
									<td colspan="3">
										<input type="file" style="width:20%;" name="file" message="파일">
									</td>
								</tr>

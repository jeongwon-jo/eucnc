						...
						<fieldset>
							...
							<div class="register_table">
								<ul class="row">
									...
									<li class="desc">
										<input type="text" name="subject" placeholder="Please enter your title" class="w100p">
								...
								<ul class="row flex-row">
									<ul class="row-item">
										...
										<li class="desc">
											<input type="text" name="writer" placeholder="Please enter your name" class="w100p">
											<!-- <span class="err-txt">Please enter your name</span> -->
										</li>
									</ul>
									<ul class="row-item">
										<li class="tit">Password</li>
										<li class="desc">
											<input type="password" name="password" placeholder="Please enter your password"
												   class="w100p">
											<!-- <span class="err-txt">Please enter your password</span> -->
										</li>
									</ul>
								</ul>
								<ul class="row">
									...
									<li class="desc">
										<textarea name="content" placeholder="Please enter your question &#13;&#10; If you would like to contact us, please leave your contact information." class="w100p"></textarea>

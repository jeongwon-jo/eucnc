...
$query_cnt = " SELECT `idx` FROM patent_info ";
...
<script defer>
    ...
    function ajax_patent(lang, pageNo, pageScale) {
        $.ajax({
            url: "/ajax/ajax_patent_prepare.php",
            dataType: "json",
            type: "POST",
            data: {
                lang: lang,
...
<div id="wrap">
	...
	<main>
			...
			<div class="menu-title__inner">
				...
				<div class="sub-menu">
					<ul class="submenu_list">
						<li class="active"><a href="./patent.php">Patent</a></li>
		...
		<div class="container reference">
			<div class="patent__inner">
				<div class="cm_title">
					<h3 class="title">Patent</h3>
				</div>
				<div class="patent__contents">
					<div class="doc__list"></div>
					<div class="btn-area center mt90">
						<button type="button" class="btn_more" onclick="ajax_patent('kor', currentPage+1, 9)"><b>More (<span
